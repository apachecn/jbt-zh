...
在JDK 1.2中添加了Collection Framework，并在1.4 -1.6中对其进行了扩展

## 收集框架的接口&类

Collection API提供了一组接口供您选择，但同时也为您提供了一些可直接使用的具体类。
...
> 并非Collection Framework中的所有类都实现Collection接口。
> 
...
##### [Java Hashmap教程](https://javabeginnerstutorial.com/core-java-tutorial/java-hashmap/ "Java Hashmap tutorial")